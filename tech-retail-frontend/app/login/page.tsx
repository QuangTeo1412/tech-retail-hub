            ...
            <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-md px-4 relative z-10">
                ...
                >
                    ...
                    <div className="relative z-10">
                        <h2 className="text-center text-2xl font-black text-slate-900 tracking-tight uppercase mb-1 drop-shadow-sm">
                            Thẻ Đăng Nhập
                        </h2>
                        <p className="text-center text-xs text-slate-600 mb-6 font-bold">
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-1">
                                    ...
                                    <Link href="/forgot-password" className="text-[11px] font-extrabold text-blue-700 hover:underline">
                                        Quên mật khẩu?
                                    </Link>
                                </div>
                            ...
                            <div className="flex items-center">
                                ...
                                />
                                <label htmlFor="remember-me" className="ml-2 block text-xs font-black text-slate-700 cursor-pointer">
                                    Ghi nhớ mật thư này
                                </label>
                            </div>
                        ...
                        <div className="mt-6 border-t border-gray-200/80 pt-4 text-center">
                            <p className="text-xs text-slate-700 font-bold">
                                ...
                                <Link href="/register" className="font-black text-blue-700 hover:underline">
                                    Đăng ký ngay
                                </Link>
                            </p>
                        </div>
